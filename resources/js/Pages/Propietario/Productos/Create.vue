                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input v-model="form.stock" type="number" step="0.01" class="w-full border-gray-300 rounded mt-1">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <div v-if="form.errors.unidad_medida" class="text-red-500 text-sm">{{ form.errors.unidad_medida }}</div>
                        </div>
                    </div>

                    <div class="mb-6">
                        <label class="block text-gray-700">Imagen del Producto</label>
                        <input type="file" @input="form.imagen = $event.target.files[0]" class="w-full mt-1 border border-gray-300 p-2 rounded">
                    ...
                    <div class="flex justify-end">
                        <Link :href="route('productos.index')" class="mr-4 px-4 py-2 text-gray-600 hover:text-gray-900">Cancelar</Link>
